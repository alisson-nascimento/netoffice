...
if (PMA_MYSQL_INT_VERSION >= 32303) {
    ...
    if ($cfgSkipLockedTables == TRUE && PMA_MYSQL_INT_VERSION >= 32330) {
        ...
        $result       = mysql_query_to_mysqli_query($local_query) or PMA_mysqlDie('', $local_query, '', $err_url_0);
                ...
                if ($result != FALSE && mysql_num_rows($result) > 0) {
                    ...
                    while ($tmp = mysqli_fetch_row($result)) {
                        ...
                        if (!isset($sot_cache[$tmp[0]])) {
                            ...
                            $sts_result  = mysql_query_to_mysqli_query($local_query) or PMA_mysqlDie('', $local_query, '', $err_url_0);
    ...
    $num_tables = (isset($tables) ? teste_count($tables) : 0);
...
if ($cfgBookmark['db'] && $cfgBookmark['table']) {
    ...
    if (($bookmark_list = PMA_listBookmarks($db, $cfgBookmark)) && teste_count($bookmark_list) > 0) {
